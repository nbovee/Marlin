...
#define STRING_CONFIG_H_AUTHOR "nbovee, CR-10 V3" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rowan CR10V3"
...
// #define LCD_BED_TRAMMING // Disabled so there is only one tramming option.
...
// #define PASSWORD_FEATURE
  ...
  #define PASSWORD_AFTER_SD_PRINT_START // Lock before starting .gcode file, Rowan Custom Option
